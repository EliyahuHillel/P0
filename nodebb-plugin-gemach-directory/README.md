...
מוגדרות רק שתי קטגוריות ("כלי עבודה" ו"וויז") - כדי להוסיף עוד, פשוט
מוסיפים מחרוזת נוספת למערך `CATEGORIES` ומפרסמים מחדש את קוד ה-Custom JS.
הרשימה הציבורית מוצגת מחולקת: כותרת לכל קטגוריה, ובתוכה חלוקה נוספת לפי
עיר - כך שהיא תמיד מסודרת גם כשמצטברים הרבה גמ"חים.
