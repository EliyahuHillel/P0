...
(function () {
	...
	// ===== הגדרה נדרשת לפני שימוש =====
	// צור/י קטגוריה חדשה ב-ACP -> Manage -> Categories (לדוגמה: "מערכת -
	// תזכורות אישיות"). זו קטגוריה טכנית - לא צריך לפרסם בה כלום, וכל
	// משתמש רואה שם רק פוסטים טכניים (של עצמו ושל אחרים, אבל בלי תוכן
	// רגיש - רק תאריך). תמצא/י את המספר שלה מתוך ה-URL של הקטגוריה,
	// למשל https://rechavimzelaze.ovh/category/91/... -> המספר הוא 91.
	var INSURANCE_CATEGORY_ID = 0; // <-- להחליף ל-ID האמיתי אחרי יצירת הקטגוריה!
